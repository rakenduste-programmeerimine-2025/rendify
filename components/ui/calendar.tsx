...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
          "group/calendar p-3 [--cell-size:1.5rem] [[data-slot=card-content]_&]:bg-transparent [[data-slot=popover-content]_&]:bg-transparent",
      ...
      classNames={{
        ...
        today: cn(
          "bg-muted text-accent-foreground rounded-md",
      ...
      <Button
          ...
          className={cn(
              ...
              [
                ...
                "dark:hover:bg-[#417bbe80]",
                "[&>span]:text-xs [&>span]:opacity-70",

                // одиночный выбранный день – полное скругление
                ...
                // start/middle/end только для настоящих диапазонов
